...
<div class="container">
    <div class="form-group row">
        <div class="col">
            <button class="btn btn-sm btn-success" onclick="location='{{ route('pages.pledge.create') }}'" id="create">เพิ่ม</button>
        </div>
    </div>
    <table class="tablesorter">
        <thead>
            <tr>
                ...
                <th scope="row">เลขบัตรประจำตัวประชาชน</th>
            ...
            <tr>
                <td scope="col">
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <button type="button" class="btn btn-sm btn-warning" onclick="location='{{ route('pages.pledge.edit',['id' => $item->product_code]) }}'" data-toggle="tooltip" data-placement="top" title="ชำระค่างวด">ชำระค่างวด</button>
                        <button type="button" class="btn btn-sm btn-danger" data-toggle="modal"  route="{{ route('pages.pledge.destroy',['id' => $item->product_code]) }}" onclick="deleteItem(this);">นำของออกจากระบบ</button>
                    </div>
                </td>
                <td scope="col"><a>{{ $item->pledge }}</a></td>
                <td scope="col"><a>{{ $item->personal_citizen_id }}</a></td>
