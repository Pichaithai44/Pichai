            ...
            <tr>
                <td scope="col">
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <button type="button" class="btn btn-sm btn-warning" onclick="location='{{ route('pages.settinguser.edit',['id' => $item->users_code]) }}'" data-toggle="tooltip" data-placement="top" title="แก้ไข"><i class="far fa-edit"></i></button>
                        <button type="button" class="btn btn-sm btn-danger" data-toggle="modal"  route="{{ route('pages.settinguser.destroy',['id' => $item->users_code]) }}" onclick="deleteItem(this);"><i class="far fa-trash-alt"></i></button>
                    </div>
                </td>
                <td scope="col"><a>{{ $item->first_name }}</a></td>
                <td scope="col"><a>{{ $item->last_name }}</a></td>
                <td scope="col"><a>{{ $item->email }}</a></td>
                <td scope="col"><a>{{ $item->created_at }}</a></td>
                <td scope="col"><a>{{ $item->updated_at }}</a></td>
                <td scope="col"><a>{{ $item->is_enable }}</a></td>
            </tr>
            @endforeach
        </tbody>
    </table>
