                    ...
                    <table class="table table-sm table-bordered">
                        <thead>
                            <tr class="text-center">
                                ...
                                <th scope="row" width="15%" class="table-primary">เลขที่ใบจำนำ</th>
                                <th scope="row" width="15%" class="table-primary">จำนวนเงินจำนำ</th>
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td scope="col">{{ $item->pay_slip_no }}</td>
                                <td scope="col">{{ number_format($item->product_capital, 2, '.', ',') }}</td>
