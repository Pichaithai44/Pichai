                    ...
                    <table class="table table-sm table-bordered">
                        <thead>
                            <tr class="text-center">
                                ...
                                <th scope="row" width="15%" class="table-primary">วันที่จ่าย</th>
                                <th scope="row" width="15%" class="table-primary">ประเภทการจ่าย</th>
                                <th scope="row" width="15%" class="table-primary">จำนวนเงิน</th>
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td scope="col">{{ number_format($item->debt_payment, 2, '.', ',') }}</td>
