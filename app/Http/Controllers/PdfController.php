...
class PdfController extends Controller
{
    ...
    public function selfcheckproduction($id)
    {
        ...
        $data->work_example = json_decode($data->work_example);
        ...
        for($i = 1 ; $i <= 3;$i++){
            ...
            $pdf::Cell(2.5,5,iconv( 'UTF-8','TIS-620',null),'L',0,'C');
            $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',$data->job_type == 'SP' ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            ...
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620','-'),0,0,'C');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',(($data->job_type == 'SP') && ($i == 1)) ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            $pdf::Cell(24.25,5,iconv( 'UTF-8','TIS-620','เริ่มต้นล๊อตการผลิต (A)'),0,0,'L');
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620','-'),0,0,'C');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',(($data->job_type == 'SP') && ($i == 2)) ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            $pdf::Cell(24.25,5,iconv( 'UTF-8','TIS-620','กลางล๊อตการผลิต (M)'),0,0,'L');
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620','-'),0,0,'C');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',(($data->job_type == 'SP') && ($i == 3)) ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            ...
            $pdf::Cell(2.5,5,iconv( 'UTF-8','TIS-620',null),'L',0,'C');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',$data->job_type == 'A' ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            ...
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620','-'),0,0,'C');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',(($data->job_type == 'A') && ($i == 1)) ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            $pdf::Cell(24.25,5,iconv( 'UTF-8','TIS-620','เริ่มต้นล๊อตการผลิต (A)'),0,0,'L');
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620','-'),0,0,'C');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',(($data->job_type == 'A') && ($i == 2)) ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            $pdf::Cell(24.25,5,iconv( 'UTF-8','TIS-620','กลางล๊อตการผลิต (M)'),0,0,'L');
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620','-'),0,0,'C');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',(($data->job_type == 'A') && ($i == 3)) ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            $pdf::Cell(24.25,5,iconv( 'UTF-8','TIS-620','ท้ายล๊อตการผลิต (Z)'),0,0,'L');
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620','-'),0,0,'C');
             $pdf::SetFont('ZapfDingbats','',14);
            ...
            $pdf::Cell(2.5,5,iconv( 'UTF-8','TIS-620',null),'L',0,'C');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',$data->job_type == 'S' ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            ...
            $pdf::Cell(2.5,5,iconv( 'UTF-8','TIS-620',null),'L',0,'C');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',$data->neck_broken[$i-1] == ('Y' || 'N') ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            $pdf::Cell(63.5,5,iconv( 'UTF-8','TIS-620','การยืดตัวและฉีกขาดของชิ้นงาน (Neck & Broken)'),0,0,'L');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',$data->neck_broken[$i-1] == 'Y' ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            $pdf::Cell(29.25,5,iconv( 'UTF-8','TIS-620','คุณภาพผ่าน'),0,0,'L');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',$data->neck_broken[$i-1] == 'N' ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            ...
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620','-'),0,0,'C');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',(($data->job_type == 'S') && ($i == 1)) ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            $pdf::Cell(24.25,5,iconv( 'UTF-8','TIS-620','เริ่มต้นล๊อตการผลิต (A)'),0,0,'L');
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620','-'),0,0,'C');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',(($data->job_type == 'S') && ($i == 2)) ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            $pdf::Cell(24.25,5,iconv( 'UTF-8','TIS-620','กลางล๊อตการผลิต (M)'),0,0,'L');
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620','-'),0,0,'C');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',(($data->job_type == 'S') && ($i == 3)) ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            $pdf::Cell(24.25,5,iconv( 'UTF-8','TIS-620','ท้ายล๊อตการผลิต (Z)'),0,0,'L');
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620','-'),0,0,'C');
             $pdf::SetFont('ZapfDingbats','',14);
            ...
            $pdf::Cell(2.5,5,iconv( 'UTF-8','TIS-620',null),'L',0,'C');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',$data->burr[$i-1] == ('Y' || 'N') ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            $pdf::Cell(63.5,5,iconv( 'UTF-8','TIS-620','ชิ้นงานมีครีบคมตัดเฉื่อน (Burr)'),0,0,'L');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',$data->burr[$i-1] == 'Y' ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            $pdf::Cell(29.25,5,iconv( 'UTF-8','TIS-620','คุณภาพผ่าน'),0,0,'L');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',$data->burr[$i-1] == 'N' ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            $pdf::Cell(29.25,5,iconv( 'UTF-8','TIS-620','คุณภาพไม่ผ่าน'),0,0,'L');
            $pdf::Cell(2.5,5,iconv( 'UTF-8','TIS-620',null),'R',0,'C');
            $pdf::Cell(3,5,iconv( 'UTF-8','TIS-620',null),0,0,'C');
            $pdf::Cell(2.5,5,iconv( 'UTF-8','TIS-620',null),'L',0,'C');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',$data->job_type == 'SCR' ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            ...
            $pdf::Cell(2.5,5,iconv( 'UTF-8','TIS-620',null),'L',0,'C');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',$data->work_example[$i-1] == ('Y' || 'N') ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            $pdf::Cell(63.5,5,iconv( 'UTF-8','TIS-620','ความแตกต่างระหว่างชิ้นงานจริงกับชิ้นงานตัวอย่าง'),0,0,'L');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',$data->work_example[$i-1] == 'Y' ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            $pdf::Cell(29.25,5,iconv( 'UTF-8','TIS-620','คุณภาพผ่าน'),0,0,'L');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',$data->work_example[$i-1] == 'N' ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            $pdf::Cell(29.25,5,iconv( 'UTF-8','TIS-620','คุณภาพไม่ผ่าน'),0,0,'L');
            $pdf::Cell(2.5,5,iconv( 'UTF-8','TIS-620',null),'R',0,'C');
            $pdf::Cell(3,5,iconv( 'UTF-8','TIS-620',null),0,0,'C');
            ...
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620','-'),0,0,'C');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',(($data->job_type == 'SCR') && ($i == 1)) ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            $pdf::Cell(24.25,5,iconv( 'UTF-8','TIS-620','เริ่มต้นล๊อตการผลิต (A)'),0,0,'L');
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620','-'),0,0,'C');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',(($data->job_type == 'SCR') && ($i == 2)) ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            $pdf::Cell(24.25,5,iconv( 'UTF-8','TIS-620','กลางล๊อตการผลิต (M)'),0,0,'L');
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620','-'),0,0,'C');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',(($data->job_type == 'SCR') && ($i == 3)) ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            $pdf::Cell(24.25,5,iconv( 'UTF-8','TIS-620','ท้ายล๊อตการผลิต (Z)'),0,0,'L');
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620','-'),0,0,'C');
             $pdf::SetFont('ZapfDingbats','',14);
            ...
            $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',$data->issue_detail[$i-1] ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            $pdf::Cell(30,5,iconv( 'UTF-8','TIS-620','ปัญหาอะไร ?'),0,0,'L');
            $pdf::SetDash(1,1);
            $pdf::Cell(68.5,5,iconv( 'UTF-8','TIS-620',$data->issue_detail[$i-1] ? $data->issue_detail[$i-1] : null),'B',0,'L');
            $pdf::SetDash();
            ...
            $pdf::Cell(10,5,iconv( 'UTF-8','TIS-620',null),0,0,'L');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',$data->issue_more_detail[$i-1] ? 4 : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            $pdf::Cell(30,5,iconv( 'UTF-8','TIS-620','เป็นปัญหาอีกหรือไม่'),0,0,'L');
            $pdf::SetDash(1,1);
            $pdf::Cell(68.5,5,iconv( 'UTF-8','TIS-620',$data->issue_more_detail[$i-1] ? $data->issue_more_detail[$i-1] : null),'B',0,'L');
            $pdf::SetDash();
            $pdf::Cell(23.5,5,iconv( 'UTF-8','TIS-620',null),0,0,'L');
            $pdf::Cell(2.5,5,iconv( 'UTF-8','TIS-620',null),'R',0,'C');
            $pdf::Cell(3,5,iconv( 'UTF-8','TIS-620',null),0,0,'C');
            ...
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',null),0,0,'L');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',$data->production_status[$i-1] == 'C' ? ($data->production_quality_result[$i-1] == 'T' ? 4 : null) : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
            ...
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',null),0,0,'L');
             $pdf::SetFont('ZapfDingbats','',14);
            $pdf::Cell(5,5,iconv( 'UTF-8','TIS-620',$data->production_status[$i-1] == 'C' ? ($data->production_quality_result[$i-1] == 'F' ? 4 : null) : null),1,0,'L');
            $pdf::SetFont('THSarabun','',12);
