...
class JobpositionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.jobposition.index',[
            'data' => $data
        ]);
    }
    ...
    public function create(Request $request)
    {
        ...
        if(Auth::user()->getAttributes()['id']){
            ...
            if($validator->fails()){
                return redirect('jobposition/add')
                ...
                return redirect()->route('pages.jobposition.index');
            }
        } else {
    ...
    public function edit($id)
    {
        ...
        $data = DB::table('job_position')
            ->where('id',$id)
            ->first();
        return view('pages.jobposition.edit',[
            'item' => $data
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if(Auth::user()->getAttributes()['id']){
            $validator = Validator::make($request->all(),$this->rules(),$this->messages());
            if($validator->fails()){
                return redirect('jobposition/edit/'.$id)
                ->withErrors($validator)
                ->withInput();
            }else{
